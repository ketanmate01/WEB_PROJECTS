<%-- 
    Document   : verify
    Created on : Sep 5, 2018, 1:11:23 AM
    Author     : ADEPT
--%>
...
<ul>
  ...
  <div class="main">
    ...
    <h1> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; VERIFY THE STUDENTS AND COMPANY</h1>
   
    
    <button class="w3-btn w3-white w3-border w3-round-large"><a href="verifystudent">VERIFY STUDENT</a></button>
    <button class="w3-btn w3-white w3-border w3-round-large"><a href="verifycompany">VERIFY COMPANY</a></button>
